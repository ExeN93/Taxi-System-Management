...
//void deleteDriver(TaxiCompany& company)
...
//void deleteCar(TaxiCompany& company)
...
//void deleteOrder(TaxiCompany& company)
...
void showOrders(const TaxiCompany& company) {
    ...
    for (int i = 0; i<company.orderCount; i++) {
        ...
        cout << "Status zamówienia: " << company.orders[i]->completed << endl << endl;
    }
}
...
void showMenu() {
    ...
    cout << "5. Wyświetl listę zamówień" << endl;
    cout << "6. Wyświetl flotę pojazdów" << endl;
    cout << "7. Oblicz całkowity zarobek" << endl;
    cout << "8. Generuj bazę danych" << endl;
    cout << "9. Wyjście" << endl;
    cout << "Wybierz opcję: ";
}
